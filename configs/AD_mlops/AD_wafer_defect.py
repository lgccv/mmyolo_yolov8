...
# 需要修改的参数
data_root = '/home/apulis-test/teamdata/jlc_dataset/wafer_defect_project/'  # Root path of data
train_ann_file = 'train/annotations/instances_annotations.json'
train_data_prefix = 'train/images/'  # Prefix of train image path
val_ann_file = 'test/annotations/instances_annotations.json'
val_data_prefix = 'test/images/'  # Prefix of val image path
class_name =  ['崩边','划痕','脏污','探针']
...
load_from = 'yolov8_l_syncbn_fast_8xb16-500e_coco_20230217_182526-189611b6.pth'  # noqa
